...
<!-- Favicon. L'ancienne version ne déclarait qu'un SVG, au format 4748×3254 :
     Google n'accepte qu'une icône carrée, et son robot cherche d'abord
     /favicon.ico — absent, d'où le globe générique dans les résultats.
     Désormais : SVG carré pour les navigateurs récents, PNG en 48 et 192
     (Google exige un multiple de 48), et un vrai favicon.ico à la racine. -->
